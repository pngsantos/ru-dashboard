	...
	<table class="table">
		<thead class="thead-dark">
			<tr>
				...
				<th scope="col">Last Cutoff</th>
				<th scope="col">Next Payout</th>
				<th scope="col">First Payout?</th>
				<th scope="col">SLP Earned (since last)</th>
				<th scope="col">Days Played (since last)</th>
				<th scope="col">Team Wgt</th>
				<th scope="col">SLP Ave</th>
