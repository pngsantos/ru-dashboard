		        ...
		        <form method="post" id="createAccount" action="{{route('accountStore')}}" class="form">
		        	...
		        	<div class="form-group">
					    ...
					    <div class="form-check">
							<input class="form-check-input" name="tags[]" type="checkbox" value="team lead" id="defaultCheck1">
							<label class="form-check-label" for="defaultCheck1">
							    Team Lead
							</label>
						</div>
						<div class="form-check">
						  	<input class="form-check-input" name="tags[]" type="checkbox" value="dev team" id="defaultCheck2">
		        	...
		        	<div class="form-group">
					    ...
					    <input type="email" class="form-control" id="accountName" name="name">
					</div>
		        	<div class="form-group">
